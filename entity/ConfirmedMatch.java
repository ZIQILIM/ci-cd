...
public class ConfirmedMatch {
    ...
    // Fetch confirmed matches (completed bookings) for a cleaner
    public List<BookingService> fetchConfirmedMatches(
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("Error retrieving confirmed matches: " + e.getMessage());
            e.printStackTrace();
        }
